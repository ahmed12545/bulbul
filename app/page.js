...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Set initial states — layer-scene becomes visible only here after positioning
  ...
  // =============================================
  const teamMembers = ["Deghdag ahmed", "Latreche firas", "Guenadez Mohamed iyad"];
  // =============================================
        ...
        <header className="header">
          <div className="header-inner">
            ...
            <div className="header-buttons">
              <a href="/login" onClick={(e) => handleFadeRoute(e, "/login")} className="btn-login">Login</a>
              <a href="/signup" onClick={(e) => handleFadeRoute(e, "/signup")} className="btn-signup">Get Started</a>
            </div>
          </div>
        </header>
                ...
                <div className="hero-center-wrap">
                  <div className="hero-content">
                    <div className="hero-left">
                      ...
                      <a href="/signup" onClick={(e) => handleFadeRoute(e, "/signup")} className="hero-main-cta">Get started for free</a>
                    </div>
        ...
        <section className="section3">
          ...
          <div className="cta-content">
            ...
            <div className="cta-buttons">
              <a href="/signup" onClick={(e) => handleFadeRoute(e, "/signup")} className="cta-primary">Get Started for Free</a>
              <a href="/login" onClick={(e) => handleFadeRoute(e, "/login")} className="cta-secondary">I already have an account</a>
            </div>
